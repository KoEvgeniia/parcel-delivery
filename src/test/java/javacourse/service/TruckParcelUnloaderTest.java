...
class TruckParcelUnloaderTest {
    ...
    public void unloadOneTruckOneParcel() {
        ...
        List<Truck> trucks = List.of(
                Truck.builder().truckSpace(new String[][]{{"3", "3", "3", null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}}).width(6).height(6).build());
        assertThat(unloader.unloadTruck(trucks)).containsExactlyInAnyOrder(
                Parcel.builder().form(new String[][]{{"3", "3", "3"}}).width(3).height(1).build()
        );
    }
    ...
    public void unloadManyTrucks() {
        ...
        List<Truck> trucks = List.of(
                Truck.builder().truckSpace(new String[][]{{"7", "7", "7", "7", null, null}, {"7", "7", "7", null, null, null}, {"9", "9", "9", null, null, null}, {"9", "9", "9", null, null, null}, {"9", "9", "9", null, null, null}, {"1", null, null, null, null, null}}).width(6).height(6).build(),
                Truck.builder().truckSpace(new String[][]{{"5", "5", "5", "5", "5", null}, {"7", "7", "7", "7", null, null}, {"7", "7", "7", null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}, {null, null, null, null, null, null}}).width(6).height(6).build());
        assertThat(unloader.unloadTruck(trucks)).containsExactlyInAnyOrder(
                Parcel.builder().form(new String[][]{{"9", "9", "9"}, {"9", "9", "9"}, {"9", "9", "9"}}).width(3).height(3).build(),
                Parcel.builder().form(new String[][]{{"7", "7", "7", "7"}, {"7", "7", "7", null}}).width(4).height(2).build(),
                Parcel.builder().form(new String[][]{{"1"}}).width(1).height(1).build(),
                Parcel.builder().form(new String[][]{{"7", "7", "7", "7"}, {"7", "7", "7", null}}).width(4).height(2).build(),
                Parcel.builder().form(new String[][]{{"5", "5", "5", "5", "5"}}).width(5).height(1).build()
        );
    }
